...
def _bucket_to_filename(bucket_name):
    """
    Convert S3 bucket name to a safe filename.
    Example: ventra-cloudtrail-s3 -> cloudtrail_s3_ventra-cloudtrail-s3.json
    """
...
def run_cloudtrail_s3(args):
    ...
    filename = _bucket_to_filename(args.bucket)
