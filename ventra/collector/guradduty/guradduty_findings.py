...
def run_guradduty_findings(args):
    ...
    try:
        ...
        if not detector_ids:
            ...
            filename = "guradduty_findings.json"
        ...
        filename = "guradduty_findings.json"
        if severity:
            filename = f"guradduty_findings_{severity.lower()}.json"
        if resource:
            safe_resource = resource.replace(":", "_").replace("/", "_")
            filename = f"guradduty_findings_{safe_resource}.json"
