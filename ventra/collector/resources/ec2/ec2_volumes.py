...
def run_ec2_volumes(args):
    ...
    for volume in volumes:
        ...
        try:
            ...
            from ventra.collector.resources.ec2.ec2_snapshots import _wait_for_snapshot_completion
            snapshot_data = _wait_for_snapshot_completion(ec2_client, snapshot_id)
            
            if snapshot_data:
                # Extract artifacts automatically
                from ventra.collector.resources.ec2.artifact_extraction import extract_artifacts_from_snapshot_auto
