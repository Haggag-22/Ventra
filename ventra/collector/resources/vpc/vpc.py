...
def collect_vpc_info(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_vpcs(**describe_kwargs)
...
def collect_vpc_subnets(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_subnets(**describe_kwargs)
...
def collect_vpc_routes(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_route_tables(**describe_kwargs)
...
def collect_vpc_security_groups(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_security_groups(**describe_kwargs)
...
def collect_vpc_nacls(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_network_acls(**describe_kwargs)
...
def collect_vpc_endpoints(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_vpc_endpoints(**describe_kwargs)
...
def collect_vpc_nat_gateways(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_nat_gateways(**describe_kwargs)
...
def collect_vpc_flow_logs(args):
    ...
    try:
        ...
        describe_kwargs = {"Filters": filters} if filters else {}
        response = ec2_client.describe_flow_logs(**describe_kwargs)
...
def collect_vpc_all(args):
    ...
    try:
        ...
        try:
            describe_kwargs = {"Filters": filters} if filters else {}
            response = ec2_client.describe_internet_gateways(**describe_kwargs)
        ...
        try:
            describe_kwargs = {"Filters": [{"Name": "vpc-id", "Values": [vpc_id]}]} if vpc_id else {}
            response = ec2_client.describe_nat_gateways(**describe_kwargs)
