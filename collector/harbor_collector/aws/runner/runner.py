...
Resolves the profile to a collector list, builds the shared context, runs each collector
(isolating failures so one error never aborts the run), assembles + signs the manifest, and
seals the package. Returns the path to the sealed evidence package.
"""
...
from ...common.chain_of_custody.signing import sign_manifest
...
from ...common.packaging.packager import PackageResult, seal_package
from ...common.profiles import Profile
