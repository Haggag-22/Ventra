...
import { GCP_COLLECTOR_PERMISSION_GROUPS } from "@/lib/gcp-collector-permissions";
import { Shield } from "lucide-react";

export function GcpPermissionScope() {
  const groupCount = GCP_COLLECTOR_PERMISSION_GROUPS.length;
    ...
    <div className="rounded-lg border border-border bg-surface-2/40 p-4">
      ...
      <div className="mt-2 space-y-1.5 text-xs leading-relaxed text-fg-subtle">
        <p>
          ...
          <code className="mono text-fg">resourcemanager.projects.get</code>
        </p>
        <p>
